...
export const createContact = (
  ...
  return axios.default.post(`/contacts`, createContactDto, options);
};

export const getCreateContactMutationOptions = <
  TError = AxiosError<ContactResponseDto>,
  TContext = unknown,
>(options?: {
...
export const updateContact = (
  ...
  return axios.default.put(`/contacts`, updateContactDto, options);
};
...
export const listContacts = (
  ...
  return axios.default.get(`/contacts`, options);
};
...
>(options?: {
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof listContacts>>> = ({
    signal,
  }) => listContacts({ signal, ...axiosOptions });
...
export const findContactsByName = (
  params: FindContactsByNameParams,
  options?: AxiosRequestConfig,
): Promise<AxiosResponse<ContactResponseDto[]>> => {
  return axios.default.get(`/contacts/search/by-name`, {
    ...options,
    params: { ...params, ...options?.params },
  });
};

export const getFindContactsByNameQueryKey = (
  params?: FindContactsByNameParams,
) => {
  return [`/contacts/search/by-name`, ...(params ? [params] : [])] as const;
};

export const getFindContactsByNameQueryOptions = <
  TData = Awaited<ReturnType<typeof findContactsByName>>,
  TError = AxiosError<ContactResponseDto[]>,
>(
  params: FindContactsByNameParams,
  options?: {
  ...
  const queryKey =
    queryOptions?.queryKey ?? getFindContactsByNameQueryKey(params);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof findContactsByName>>
  > = ({ signal }) => findContactsByName(params, { signal, ...axiosOptions });
...
export type FindContactsByNameQueryResult = NonNullable<
  Awaited<ReturnType<typeof findContactsByName>>
>;
export type FindContactsByNameQueryError = AxiosError<ContactResponseDto[]>;

export function useFindContactsByName<
  TData = Awaited<ReturnType<typeof findContactsByName>>,
  TError = AxiosError<ContactResponseDto[]>,
>(
  params: FindContactsByNameParams,
...
>(
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getContactStats>>> = ({
    signal,
  }) => getContactStats(id, { signal, ...axiosOptions });
...
export const getContact = (
  ...
  return axios.default.get(`/contacts/${id}`, options);
};
...
>(
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getContact>>> = ({
    signal,
  }) => getContact(id, { signal, ...axiosOptions });
...
export const deleteContact = (
  ...
  return axios.default.delete(`/contacts/${id}`, options);
};
