...
export default function Auth() {
  ...
  const handleLogin = (data: LoginDto) => {
    signIn(
      ...
      {
        onSuccess: (res) => {
          enqueueSnackbar(t('auth.messages.loginSuccess'), {
            variant: 'success',
          });
          login(res.data);
          navigate('/');
  ...
  const handleRegister = (data: CreateUserDto) => {
    createUser(
      ...
      {
        onSuccess: () => {
          enqueueSnackbar(t('auth.messages.registerSuccess'), {
            variant: 'success',
          });
          signIn(
        ...
        onError: () => {
          enqueueSnackbar(t('auth.messages.registerError'), {
            variant: 'error',
          });
        },
      },
